...
def visualize_boxes_and_labels_on_image_array(
  ...
  def telegram_bot(message):
    bot_token = '1671032373:AAEA3R7uYHcrqA6y8AXmpYd02ug6NSKAK9M'
    bot_chatID = '799408053'
    send_text = 'https://api.telegram.org/bot' + bot_token + '/sendMessage?chat_id=' + bot_chatID + '&parse_modeMarkdownV2&text=' + message
        ...
        if not skip_labels:
          if not agnostic_mode:
            if classes[i] in six.viewkeys(category_index):
              ...
              if (class_name == 'menetas'): 
                telegram_bot("Ada Telur Menetas")
